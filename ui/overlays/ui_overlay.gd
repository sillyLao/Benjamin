...
@onready var scale_bar = $"IG UI/ScaleBar"
@onready var progress_bar = $"IG UI/ScaleBar/ProgressBar"
...
var notification_scene : PackedScene = preload("res://ui/overlays/notification.tscn")
var kill_line_scene : PackedScene = preload("res://ui/overlays/kill_line.tscn")
var hit_pos_indicator_scene : PackedScene = preload("res://ui/effects/hit_position_indicator.tscn")
var tab_line_scene : PackedScene = preload("res://ui/overlays/tab_line.tscn")
...
func _physics_process(delta):
	...
	if Global.in_game:
		...
		if blaster_reload.value >= 0.96:
			blaster_reload.modulate += Color(1, 1, 1, delta*-2)
		else:
			blaster_reload.modulate.a = 168.0/255.0
...
func quit_to_lobby():
	...
	$GameEnded.hide()
	get_tree().change_scene_to_file("res://ui/menus/online_lobby_menu.tscn")
